...
if ($_SERVER["REQUEST_METHOD"] == "GET" && !empty($_GET['keyword'])) {
  ...
  $sql_get = "SELECT * FROM users WHERE fullname LIKE '%$keyword%' OR username LIKE '%$keyword%'";
} else {
  $sql_get = "SELECT * FROM users LIMIT $start, $limit";
}
...
<body>
 <!-- เมนู -->
  <nav class="navbar navbar-expand-lg" style="background-color: #b1ddfde3;" data-bs-theme="light">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#">
            <i class="bi bi-house-door-fill"></i> หน้าหลัก</a> <!-- ไอคอนบ้าน -->
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          <i class="bi bi-clipboard-data-fill"></i> รายงานผลข้อมูล</a> <!-- ไอคอนรายงาน -->
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#">รายงานข้อมูลผู้ใช้</a></li>
            <li><a class="dropdown-item" href="#">รายงานขวัสดุงานอาคาร</a></li>
        ...
        <li class="nav-item">
          <a class="nav-link btn btn-outline-danger" href="#">
                 <i class="bi bi-door-open-fill"></i> ออกจากระบบ <!-- ไอคอนประตู -->
          </a>
        </li>
        <!-- <li class="nav-item">
...
<!-- จบเมนู -->
 <div class="container text-center my-4 bg-primary-subtle rounded-3 text-primary">
    <h1><i class="bi bi-clipboard-data-fill"></i> รายงานผลข้อมูลผู้ใช้</h1>
 </div>
<!-- ช่องเสริซ -->
 <div class="container">
  <div class="row">
...
// output data of each row
    ...
    <tr>
      <th scope="row" class="text-center"><?php echo $row["user_id"]; ?></th>
      <td><?php echo $row["fullname"]; ?></td>
      <td><?php echo $row["username"]; ?></td>
      <td class="text-center">
        <a class="btn btn-danger" href="user_del.php?del_id=<?php echo $row["user_id"]; ?>" role="button" onclick="return confirm('คุณแน่ใจหรือไม่ว่าต้องการลบ?');"> ลบ </a>
        <a class="btn btn-warning" href="user_update_v2.php?edit_id=<?php echo $row["user_id"] ?>"> แก้ไข </a>
